...
@section('content-area')
    <div class="right_col" role="main">
        ...
        <input type="hidden" name="others" id="others" value="@if(request()->has('others')) 1 @else 0 @endif"/>
        ...
        <input type="hidden" id="filter_trashed" value="{{request()->has('filter_trashed') ? 1 : 0 }}"></input>
        {!! Form::token() !!}
        </form>
